        ...
        if (e.getSource() == btIniciar) {
            ...
            //Comprobamos si estamos en la cola ROund Robin
                ...
                if (clientesPrioridades.longitud() != 0){
                    ...
                    if (tiempo-clientesPrioridades.Cabecera.llegada>9){
                        ...
                        clientes.insert(aux.prioridad, aux.llegada, aux.rafaga, aux.nombre+"{N}", aux.fila, aux.rafagaRestante
                                , aux.tiempoBloqueo, aux.rafagaEjecutada, aux.tfPrecursor, 1);
                ...
                if (clientesRafaga.longitud() != 0){
                    ...
                    if (tiempo-clientesRafaga.Cabecera.llegada>9){
                        ...
                        clientesPrioridades.insert(aux.prioridad, aux.llegada, aux.rafaga, aux.nombre+"{N}", aux.fila, aux.rafagaRestante
                ...
                if (Quantum < 3) {
                    ...
                    clientes.insert(auxNode.prioridad, auxNode.llegada, auxNode.rafaga - 3, auxNode.nombre + " (E)", auxNode.fila, auxNode.rafagaRestante, auxNode.tiempoBloqueo, auxNode.rafagaEjecutada, tiempo, auxNode.numCola);
                    clientes.extraer(1);
                    clienteInicial = true;
            ...
            //Miramos si la persona actual es de la cola de rafagas
                ...
                //Si la cola no esta vacia y el tiempo global no ha excedido 30 unidades
                if (clientesRafaga.longitud() != 0 || tiempo <= 30) {
